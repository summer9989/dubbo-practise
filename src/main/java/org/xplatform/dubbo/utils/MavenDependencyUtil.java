package org.xplatform.dubbo.utils;
...
public class MavenDependencyUtil {
    ...
    private static ArtifactRepository localRepository() throws Exception {
        ...
        String url = StringUtils.isEmpty(path) ? "file://" + System.getProperty("user.home") + "/.m2/repository" : "file://" + path;
        return FACTORY.createArtifactRepository("local", url, (ArtifactRepositoryLayout) new DefaultRepositoryLayout(), null, null);
    }
